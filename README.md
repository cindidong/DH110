...
<iframe width="100%" height="100%" src="https://www.youtube.com/embed/VfO5F0VYkOY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
- The participant preferred a more textbook format. This was because the textbook format (a page with all the information laid out in text on it) allowed them to quickly scan for relevant information. As [musictheory.net](https://www.musictheory.net/) is more interactive and has animations/slideshows, it's much harder to quickly scan through the entire lesson for relevant sections. An intermediate level in music theory would do this a lot more than beginners.
...
- The participant preferred the font Jost, as they described it as having more "character" than the other fonts. 
- The participant preferred rounder buttons, but stated that this might be a personal preference. They did not like the rectangle buttons, stating that it makes the website look unfinished. 
- The participant preferred a higher contrast between the background and the text.

See more [here](https://cindidong.github.io/DH110/Assignments/6/).

#### Cognitive Walkthrough
I conducted this cognitive walkthrough in class, with my peers. [Link to Comments](https://docs.google.com/document/d/1SOS-NN-_a3UrTWoGuX56GD1WqbyoErZwoCBFRIQ4-U8/edit)
